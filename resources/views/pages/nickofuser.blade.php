    ...
    <div class="c-layout-breadcrumbs-1 c-fonts-uppercase c-fonts-bold c-bordered c-bordered-both">
       <div class="container">
          <div class="c-page-title c-pull-left">
             <h3 class="c-font-uppercase c-font-sbold"><a href="" title="Blog tin tức">Danh Sách Nick Đã Mua</a></h3>
          </div>
          ...
          <div class="row">
             <div class="col-md-9">
                <div class="art-list">
                   ...
                   <div class="a-item">
                      <div class="thumbnail-image img-thumbnail"><a href=""><img src="{{asset('uploads/nicks/'.$blg->image)}}" alt="png-image"></a></div>
                      <div class="info">
                         <div class="article_title ">
                            {{-- <h2><a href="{{route('blogs_detail',[$blg->slug])}}" style="text-transform: initial;">{{$blg->title}}</a></h2> --}}
                         </div>
                         <a href="{{route('accgame',[$blg->ms])}}" >
                         <div class="article_cat_date">
                            <div style="display: inline-block;margin-right: 15px"><i class="fa fa-calendar" aria-hidden="true"></i>   Tài Khoản :  {{$blg->taikhoan}}</div>
                            <div style="display: inline-block"><i class="fa fa-newspaper-o" aria-hidden="true"></i> 
                           
                              Mật Khẩu : {{Crypt::decryptString($blg->matkhau)}}
