    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <span style="max-width:100px" id="video_link"> </span>
        </div>
    ...
    <div class="c-layout-breadcrumbs-1 c-fonts-uppercase c-fonts-bold c-bordered c-bordered-both">
       <div class="container">
          <div class="c-page-title c-pull-left">
             <h3 class="c-font-uppercase c-font-sbold"><a href="/blog" title="Blog tin tức">Video </a></h3>
          </div>
          ...
          <div class="row">
             <div class="col-md-9">
                <div class="art-list">
                   ...
                   <div class="a-item">
                      <div class="thumbnail-image img-thumbnail"><a class="video-click" onclick="return video_highlight({{$blg->id}})" data-video_id="{{$blg->id}}"><img src="{{asset('uploads/video/'.$blg->image)}}" alt="png-image"></a></div>
                      <div class="info">
                         <div class="article_title ">
                            {{-- {{route('blogs_detail',[$blg->slug])}} --}}
                            <h2><a href="" style="text-transform: initial;">{{$blg->title}}</a></h2>
                         </div>
